...
export class ContextSelectorElement extends PolymerElement {
    ...
    appendContext(context) {
        ...
        // Here I will dynamically create the button and the div.
        ...
        this.context_buttons.appendChild(context.button)
        ...
        context.button.onclick = function (contextSelector, context) {
            return function () {
                ...
                for (var id in contextSelector.contexts) {
                    ...
                    ctx.button.classList.remove("active_context_button")
                    // Here I will also hide it div
                ...
                // Append the visible.
                context.button.classList.add("active_context_button")
        ...
        // Append element from context slot to divs element.
